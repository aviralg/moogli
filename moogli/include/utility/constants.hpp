...
const osg::Vec4f CYLINDRICAL_COMPARTMENT_COLOR = osg::Vec4f(1.0f, 0.5f, 0.0f, 0.5f); //orange
const osg::Vec4f SPHERICAL_COMPARTMENT_COLOR   = osg::Vec4f(0.5f, 0.0f, 1.0f, 0.5f); //violet
...
// const osg::Vec4f RED
// const osg::Vec4f GREEN
// const osg::Vec4f BLUE
// const osg::Vec4f CYAN
// const osg::Vec4f MAGENTA
// const osg::Vec4f YELLOW
// const osg::Vec4f ORANGE
// const osg::Vec4f VIOLET
